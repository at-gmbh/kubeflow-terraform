...
module network {
  ...
  source             = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/network?ref=v1.0.15"
...
// Kubernetes Cluster
module kubernetes {
  source             = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/kubernetes?ref=v1.0.15"
  availability_zones = var.availability_zones
  environment        = var.environment
  project            = var.project
  cluster_name       = var.cluster_name
...
module acm_certificate {
  source                    = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/acm-certificate/?ref=v1.0.15"
...
// Create RDS instance
module "rds" {
  source  = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/rds?ref=v1.0.15"
...
// Create S3 bucket
module "s3" {
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/storage/s3?ref=v1.0.15"
  module_depends_on = []
...
// ArgoCD
module argocd {
  source                    = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/cicd/argo-cd?ref=v1.0.15"
...
module mlflow {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/mlflow?ref=v1.0.15"
...
module kube2iam {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/kube2iam?ref=v1.0.15"
  argocd = module.argocd.state
...
module kfserving {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/kfserving/0-3-0/?ref=v1.0.15"
  argocd = module.argocd.state
}

// Create YAML specs for External-Secrets
module external_secrets {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/external-secrets?ref=v1.0.15"
  argocd = module.argocd.state  
  cluster_name = var.cluster_name
...
module kubeflow {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/kubeflow-operator?ref=v1.0.15"
  rds_username = module.rds.this_db_instance_username
  rds_password = module.rds.this_db_instance_password  
  rds_host = module.rds.this_db_instance_address
  rds_port = module.rds.this_db_instance_port
...
module cluster_autoscaler {
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/cluster-autoscaler?ref=v1.0.15"
  image_tag         = "v1.15.7"
  cluster_name      = module.kubernetes.cluster_name
  module_depends_on = [module.kubernetes]
  argocd            = module.argocd.state
...
module cert_manager {
  module_depends_on = [module.kubernetes]
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/cert-manager?ref=v1.0.15"
  cluster_name      = module.kubernetes.cluster_name
  domains           = [var.domain]
  vpc_id            = local.vpc_id
  environment       = var.environment
...
module alb_ingress {
  module_depends_on = [module.kubernetes]
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/ingress/aws-alb?ref=v1.0.15"
  cluster_name      = module.kubernetes.cluster_name
  domains           = [var.domain]
  vpc_id            = local.vpc_id
...
module external_dns {
  source       = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/external-dns?ref=v1.0.15"
  cluster_name = module.kubernetes.cluster_name
  vpc_id       = local.vpc_id
